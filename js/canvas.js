...
class CanvasBackground {
    ...
    canvasSize(){
        this.canvas.width=this.canvas.offsetWidth * this.dpr// а я записал так почему-то devicePixelRatio (this.dpr);
        this.canvas.height=this.canvas.offsetHeight * this.dpr// devicePixelRatio (this.dpr);
        //this.ctx= devicePixelRatio (this.dpr);
